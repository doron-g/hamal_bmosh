"""
Django settings for hamal project.
...
class Base(Configuration):
    ...
    SECRET_KEY = values.Value('yXcJiYrbhTMpXndYFMrOXauJeewuowVlEwNZPzMBSmrCQBqoUD')
    ...
    WSGI_APPLICATION = "hamal.wsgi.application"

    # Database
    # https://docs.djangoproject.com/en/4.1/ref/settings/#databases

    DATABASES = values.DatabaseURLValue("postgresql://hamal_user:hamal_pass@127.0.0.1:5432/hamal_db")
