...
class Hanich(models.Model):
    ...
    mahoz = models.ForeignKey(to="mifal_management.Mahoz", on_delete=models.SET_NULL, null=True, blank=True,
                              verbose_name=hebrew_constants.MAHOZ)
    ken = models.ForeignKey(to="mifal_management.Ken", on_delete=models.SET_NULL, null=True, blank=True,
                            verbose_name=hebrew_constants.KEN)
    grade = models.ForeignKey(to="mifal_management.Grade", on_delete=models.SET_NULL, null=True, blank=True,
...
class HanichExtraQuestion(models.Model):
    hanich_in_event = models.ForeignKey(to="mifal_management.HanichInEvent", on_delete=models.CASCADE,
