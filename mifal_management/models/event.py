...
class HanichInEvent(models.Model):
    hanich = models.ForeignKey(to="mifal_management.Hanich", on_delete=models.SET_NULL, related_name="event_participations",#todo: change to cascade
                               null=True, verbose_name=hebrew_constants.HANICH)
    event = models.ForeignKey(to="mifal_management.Event", on_delete=models.SET_NULL, related_name="hanichim", null=True,#todo: change to cascade
                              verbose_name=hebrew_constants.EVENT)
    group = models.ForeignKey(to="mifal_management.EventGroup", on_delete=models.SET_NULL, null=True, blank=True,
