...
class BusStop(models.Model):
    date = models.DateField(null=True, blank=True, verbose_name=hebrew_constants.DATE)
    bus = models.ForeignKey(to="mifal_management.Bus", on_delete=models.CASCADE, related_name="stops",
                            verbose_name=hebrew_constants.BUS)
...
class HanichBusAssignment(models.Model):
    hanich = models.ForeignKey(to="mifal_management.Hanich", on_delete=models.CASCADE, verbose_name=hebrew_constants.HANICH)
    bus = models.ForeignKey(to="mifal_management.Bus", on_delete=models.CASCADE, verbose_name=hebrew_constants.BUS)
