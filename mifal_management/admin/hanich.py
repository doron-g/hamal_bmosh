...
from mifal_management.admin import HanichBusAssignmentInlineAdmin
from mifal_management.models import Hanich, StatusHanich, HanichExtraQuestion, HanichInEvent
from mifal_management.resources import HanichResource
