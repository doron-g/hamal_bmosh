...
from mifal_management.models import Hanich, Mahoz, Event
from mifal_management.models import HanichInEvent, HanichExtraQuestion
from mifal_management.tests.base import HamalBaseTestCase, MinimalImportFormat


class HanichImportTestCase(HamalBaseTestCase):
    def setUp(self):
        super().setUp()
        self.base_url = reverse("admin:mifal_management_hanich_changelist")
        self.import_url = reverse("admin:mifal_management_hanich_import")
